function initCanvas(){
    ...
    function Launcher(){
        ...
        this.render = function () {
            ...
            ctx.drawImage(backgroundImage, 20, 20); 
            ctx.drawImage(naveImage,this.x,this.y, 100, 90);

            for(var i=0; i < this.misiles.length; i++){ // continue read here this :x :V :D D:
        ...
        this.hitDetectLowerLevel = function(enemy){
            ...
            if(enemy.y > 550){
                ...
                this.gameStatus.message = 'Los enemigos te han rodeado';
            }
            ...
            if ((enemy.y < this.y + 25 && enemy.y > this.y - 25) &&
                (enemy.x < this.x + 45 && enemy.x > this.x - 45)) { 
                    this.gameStatus.over = true;
                    this.gameStatus.message = 'Te atraparon!'
                }
